...
export default async function AsignarMotoPage({
    ...
    const esquemaTipo = await obtenerEsquemaReparacionAsignarParte();
    ...
    const clienteres = await obtenerReparacionPorId(cliente);
    if (!clienteres) {
        return (
            <div className="flex justify-content-center">
                <Card title="Error" className="w-6"
    ...
    return (
        ...
        <div className="flex justify-content-center">
            <FormComponent modo="asignar" esquema={esquemaTipo} valoresIniciales={
                valoresIniciales}
                tipoCreacion={"reparacionAsignarParte"}
                preasignado ={{
                    reparacionId: clienteres?.id,
                    reparacion: clienteres,
                    parteId: null,
                    parte: null,
                }}
