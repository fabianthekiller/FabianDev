import { obtenerEsquemaClienteCrear } from "@/actions/cliente/crud";
...
export default async function ClientesCrearPage() {

    const esquemaTipo = await obtenerEsquemaClienteCrear();
